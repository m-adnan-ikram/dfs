<nav class="navbar navbar-expand-lg main-navbar sticky bg-white">
                ...
                <div class="dropdown-list-content dropdown-list-icons">
                    <a href="#" class="dropdown-item dropdown-item-unread"> <span class="dropdown-item-icon bg-primary text-white"> <i class="fas
                            ...
                            clean it! <span class="time">17 Hours Ago</span>
                                            ...
                                            fa-bell"></i>
                        </span> <span class="dropdown-item-desc"> Welcome to DFS
    ...
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="{{ route('main') }}"> 
                ...
                <!-- <span class="logo-name">DFS</span> -->
            </a>
        </div>
        <ul class="sidebar-menu">
            <li class="menu-header">Main</li>
            <li class="dropdown">
                <a href="{{ route('main') }}" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
            </li>
            <li class="menu-header">Settings</li>
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="command"></i><span>Accounting</span></a>
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{ route('tier.sub_ledger') }}">Sub Ledger</a></li>
                </ul>
            </li>
        </ul>
    </aside>
